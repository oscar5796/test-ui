  ...
  return (
    <div className="info-card">
      <div className="info-card__person-info">
        ...
        <span><img className="info-card__person-info__wiki-logo" src={WikiLogo} alt="wiki-logo" /> <a className="info-card__person-info__more" href="https://en.wikipedia.org/wiki/Pope_Francis">More information</a></span>
        <h3>What's Your Verdict?</h3>
      </div>
      <div className="info-card__actions">
        <button aria-label="upvote" className="info-card__actions__upvote">
          <ThumbUpIcon style={{ fontSize: 40 }} className="info-card__actions__upvote--icon"/>
        </button>
        <button aria-label="downvote" className="info-card__actions__downvote">
          <ThumbDownAltIcon style={{ fontSize: 40 }} className="info-card__actions__downvote--icon"/>
        </button>
      </div>
    </div>
  );
